...
@section('content')
    ...
    <section class="">
        <div class="container mx-auto py-5" id="profile-container" style="display: none">
            <h2 id="profile-name" class="text-3xl font-bold mb-5 p-5">Roni's Profile</h2>
            <div class="flex">
    ...
    <div id="login-register-info"
        class="hidden h-[90vh] bg-gradient-to-r from-orange-200 to-pink-200 text-blue-800 p-4 rounded-lg">

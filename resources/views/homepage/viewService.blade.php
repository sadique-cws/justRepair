...
<div class="container">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Book Free Visit</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Rate(s)</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">FAQs</button>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-1" id="calling_requirement">
                                        @foreach ($service->requirements as $item)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="req_{{ $item->id }}">
                                            <label class="form-check-label" for="req_{{ $item->id }}">{{ $item->req_name }}</label>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <button class="btn btn-success rounded-pill w-100" type="submit"><i class="fa-solid fa-calendar-days"></i> Book Appointment Online</button>
                                </div>
                                <div class="mb-3 text-center">
                                    <hr><span>OR Book Via Call (9AM to 6PM)</span><hr>
                                </div>
                                <div class="mb-3">
    ...
    <div class="row mt-3">
        <div class="col-lg-12">
            ...
            <p class="text-muted text-sm">We provide same day quick service including Saturday and Sunday and all our repair services come with a 7 days repair warranty policy. We promise to revisit and re-check in case your AC is not fully working without any additional charges up to 7 days from the date of the first service.</p>

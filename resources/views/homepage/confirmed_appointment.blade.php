...
<div class="flex flex-col justify-center items-center mt-8">
    <div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        ...
        <h1 class="text-3xl text-center font-bold text-gray-800 mt-4">Appointment Booked Successfully</h1>
            ...
            let calling_comp = () => {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        appointmentDetailsHtml += '<p class="border border-slate-300 my-5 bg-slate-200 text-3xl text-center p-3 rounded text-slate-800"><strong>Complaint Number:</strong>  <span class="text-red-600 font-semibold">' +
